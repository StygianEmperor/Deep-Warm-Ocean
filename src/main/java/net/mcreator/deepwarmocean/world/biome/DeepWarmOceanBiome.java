...
package net.mcreator.deepwarmocean.world.biome;
...
import net.mcreator.deepwarmocean.DeepwarmoceanModElements;

@DeepwarmoceanModElements.ModElement.Tag
public class DeepWarmOceanBiome extends DeepwarmoceanModElements.ModElement {
	public static Biome biome;
	public DeepWarmOceanBiome(DeepwarmoceanModElements instance) {
		super(instance, 1);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-8674049).setWaterColor(-12331538).setWaterFogColor(-16507085)
						.withSkyColor(-8674049).withFoliageColor(10387789).withGrassColor(-4138753)
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.SEAGRASS
						.withConfiguration(new ProbabilityConfig(0.3F)).func_242731_b(7).withPlacement(Features.Placements.SEAGRASS_DISK_PLACEMENT));
				...
				event.getRegistry().register(biome.setRegistryName("deepwarmocean:deep_warm_ocean"));
			}
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), BiomeDictionary.Type.HOT,
				BiomeDictionary.Type.WET, BiomeDictionary.Type.OCEAN, BiomeDictionary.Type.WATER, BiomeDictionary.Type.OVERWORLD);
